...
#### Inserir Pais
PaisSemInformacao_DF = pd.DataFrame(data=[['Sem Informação']], columns=['Pais'])
ListaPais = DadosSelecionados['Country'].unique()
Pais_DF = pd.DataFrame(data=ListaPais, columns=['Pais'])
Pais_DF = PaisSemInformacao_DF.append(Pais_DF)
...
LinguagemSemInformacao_DF = pd.DataFrame(data=[['Sem Informação']], columns=['LinguagemProgramacao'])
ListaCompleta_DF = pd.DataFrame(data=ListaCompleta, columns=['LinguagemProgramacao'])
ListaCompleta_DF = ListaCompleta_DF.dropna()
ListaCompleta_DF = LinguagemSemInformacao_DF.append(ListaCompleta_DF)
...
FerramentaSemInformacao_DF = pd.DataFrame(data=[['Sem Informação']], columns=['FerramentaComunicacao'])
ListaCompleta_DF = pd.DataFrame(data=ListaCompleta, columns=['FerramentaComunicacao'])
ListaCompleta_DF = ListaCompleta_DF.dropna()
ListaCompleta_DF = FerramentaSemInformacao_DF.append(ListaCompleta_DF)
for index, row in ListaCompleta_DF.iterrows():
...
SistemaOperacionalSemInformacao_DF = pd.DataFrame(data=[['Sem Informação']], columns=['SistemaOperacional'])
ListaCompleta_DF = pd.DataFrame(data=ListaCompleta, columns=['SistemaOperacional'])
ListaCompleta_DF = ListaCompleta_DF.dropna()
ListaCompleta_DF = SistemaOperacionalSemInformacao_DF.append(ListaCompleta_DF)
for index, row in ListaCompleta_DF.iterrows():
...
# Inserir empresa (tamanho da empresa)
EmpresaSemInformacao_DF = pd.DataFrame(data=[['Sem Informação']], columns=['TamanhoEmpresa'])
ListaCompleta_DF = pd.DataFrame(data=ListaCompleta, columns=['TamanhoEmpresa'])
ListaCompleta_DF = ListaCompleta_DF.dropna()
ListaCompleta_DF = EmpresaSemInformacao_DF.append(ListaCompleta_DF)
for index, row in ListaCompleta_DF.iterrows():
...
display(UsuarioIsrael['Salario'].mean())
